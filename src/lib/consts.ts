...
export const TRACKS: TrackMeta[] = [
  ...
  },
  {
    ...
    categories: [
      { key: 'marfuaat', title: 'المرفوعات', blurb: 'المرفوعات' },
      { key: 'mansubat', title: 'المنصوبات', blurb: 'المنصوبات' },
      { key: 'majrurat', title: 'المجرورات والتوابع', blurb: 'المجرورات والتوابع' },
      { key: 'jumal', title: 'الجمل والأساليب', blurb: 'الجمل والأساليب' },
    ],
  },
  {
    key: 'sarf',
