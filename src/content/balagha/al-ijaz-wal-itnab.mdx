  ...
  - q: "أيٌّ من الآتي إطنابٌ مقبول لا تطويل مذموم؟"
    ...
    options:
      - text: "التذييل بجملة تقرر ما قبلها وتجري مجرى المثل"
        text_en: "A tailpiece (tadhhīl) sentence that clinches what preceded and runs like a proverb"
        correct: true
    ...
    explain_en: "Praiseworthy iṭnāb is extra wording that serves a rhetorical purpose — such as tadhhīl (tailpiece), where a closing sentence clinches and universalises the preceding statement, making it memorable like a proverb. Taṭwīl (wordiness) and ḥashw (padding) are blameworthy because they add nothing of rhetorical value."
